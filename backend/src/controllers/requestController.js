...
exports.createRequest = async (req, res) => {
  try {
    const { studentId, studentName, studentEmail, equipmentId, equipmentName, borrowFromDate, borrowToDate, notes } = req.body;

    // ============================================================
    // 1. VALIDATION
    // ============================================================

    if (!studentId || !equipmentId || !borrowFromDate || !borrowToDate || !notes) {
    ...
    // ============================================================
    // 3. CHECK FOR CONFLICTING REQUESTS
    // ============================================================
    ...
    if (conflictingRequest) {
      return res.status(400).json({
        success: false,
        message: 'Equipment is already requested for these dates',
      });
    }
...
exports.markReturned = async (req, res) => {
  try {
    ...
    if (equipment) {
      await equipment.increaseAvailable(1);
    }
